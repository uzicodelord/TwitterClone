    ...
    public function displayTweets(): void
    {
        while ($row = $this->result->fetch_assoc()) {
            ...
            if ($row['tweeter_name'] == $_SESSION['username']) {
                ...
                echo "<input class='btn btn-danger btn-lg'= type='button' value='Delete' style='float:right;'>";
                echo "</form>";
            }
            $tweetId = $row['id'];
            ...
            echo "<button style='float:left;margin-top:-20px;' type='button' class='btn btn-success btn-lg' onclick='submitComment($tweetId, \"" . $textareaId . "\")'>Comment</button><br><br><br>";
            echo "</form>";
